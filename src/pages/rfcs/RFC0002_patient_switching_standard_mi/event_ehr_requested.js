...
import ehrRequested from "../../../../static/RFC00002_patient_switching_standard_mi/payloads/ehrRequested.json"
import "../../index.scss"
...
const Page = () => (
  <>
    ...
    >
      ...
      <Pagination>
        <Pagination.Previous
          href={withPrefix("rfcs/RFC00002_patient_switching_standard_mi/event_registration_started")}
        >
          Event: Registration Started
        </Pagination.Previous>
        <Pagination.Next
          href={withPrefix("rfcs/RFC00002_patient_switching_standard_mi/event_ehr_generated")}
        >
          Event: EHR Generated
        </Pagination.Next>
      </Pagination>
