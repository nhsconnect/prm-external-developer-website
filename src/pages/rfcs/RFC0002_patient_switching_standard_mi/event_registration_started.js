...
import registrationStarted from "../../../../static/RFC00002_patient_switching_standard_mi/payloads/registrationStarted.json"
import "../../index.scss"
...
const Page = () => (
  <>
    ...
    >
      ...
      <Pagination>
        <Pagination.Previous href={withPrefix("rfcs/RFC00002_patient_switching_standard_mi/data")}>
          New data to be collected
        </Pagination.Previous>
        <Pagination.Next
          href={withPrefix("rfcs/RFC00002_patient_switching_standard_mi/event_ehr_requested")}
        >
          Event: EHR Requested
        </Pagination.Next>
      </Pagination>
