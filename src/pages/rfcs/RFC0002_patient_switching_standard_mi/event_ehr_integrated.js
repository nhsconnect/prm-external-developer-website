    ...
    >
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            An object that contains information about the gp transfer
          </td>
        </tr>
        <tr>
          <td>integration</td>
          <td>
            An object that contains integration details about the GP transfer
          </td>
        </tr>
        </tbody>
      </table>
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            The ISO 8601 Date time in UTC of when the EHR transferred
            was integrated by the clinical staff in the receiving practice.
          </td>
        </tr>
        </tbody>
      </table>
