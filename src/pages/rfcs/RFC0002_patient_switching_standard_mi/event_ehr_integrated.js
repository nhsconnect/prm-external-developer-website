...
import ehrIntegrated from "../../../../static/RFC00002_patient_switching_standard_mi/payloads/ehrIntegrated.json"
import "../../index.scss"
...
const Page = () => (
  <>
    ...
    >
      ...
      <Pagination>
        <Pagination.Previous
          href={withPrefix("rfcs/RFC00002_patient_switching_standard_mi/event_ehr_validated")}
        >
          Event: EHR Validated
        </Pagination.Previous>
        <Pagination.Next
          href={withPrefix("rfcs/RFC00002_patient_switching_standard_mi/event_registration_completed")}
        >
