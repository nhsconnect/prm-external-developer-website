    ...
    <>
      ...
      >
        ...
        <p>
          ...
          usable data for tracking trends in GP2GP, there are several drawbacks
          we have experienced working with it in practice:
        </p>
        <ul>
          <li>
            Lack of extensibility - Due to the high amount of cross referencing
            to the structure and numbering scheme of the MI fields, it is hard
            to add new data to the existing specification.
          </li>
          <li>
            Inability to represent structured data - Because CSV is used as a
            serialisation format, it's not easy to add data that is structured
            or list like (e.g attachment metadata).
          </li>
          <li>
            Inconsistent and unreported information - The implementations of
            GP2GP MI contain inconsistencies amongst each other, so data can be
            missing and the accuracy of our analysis is reduced.
          </li>
          <li>
            Challenges de-duplicating records - There is no unique identifier
            that can be used to de-duplicate the MI records in the way outlined
            by the existing specification.
          </li>
          <li>
          ...
          <li>
            Scope of data capture - When considering patient record migration as
            a whole, registration data is important for measuring the overall
          ...
          <li>
            ...
            respond to incidents as well as hampering our ability to build
            useful data products on top of the MI data.
          </li>
        </ul>
        <h3>Technical Design</h3>
        <p>
          To address the above concerns, we propose moving to real time events
        ...
        <p>
          ...
          this way will improve our ability to analyse different kinds of GP2GP
          failure modes. This will also make it simpler to capture new kinds of
          information, as instead of placing more data into a single record, new
        ...
        <p>
          ...
          column in the logically correct place, as any code which processes
          this CSV now potentially needs to be updated to take into account the
          new ordering. In the existing specification, this is further
          complicated as the order of the requirements is directly reflected by
          the CSV.
        </p>
        <p>
          ...
          meaning. It will therefore be considerably easier to evolve the
          schema. In addition to this we also recommend fully decoupling the
          numbering and ordering of the requirements from the data schema. For
          example, if the specification dictates in requestor requirement 2 that
          a requesting system records the conversation id, the field in the data
          schema should be something like ‘conversation_id’ instead of ‘RR2’.
          The enhanced MI specification will contain a data schema mandating
        ...
        <p>
          ...
          registration. At the moment we only get this unique identifier when a
          GP2GP conversation is started (via the 'ConversationID').
        </p>
        <p>
