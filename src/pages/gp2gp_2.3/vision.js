    ...
    <Layout>
      ...
      <div className="app-pane__main-content">
        ...
        <p>
          ...
          the CSV. Encoding the same information into a JSON record does not
          suffer from this limitation as the order of values are not used for
          conveying meaning. It will therefore be considerably easier to evolve
          the schema. In addition to this we also recommend fully decoupling the
        ...
        <p>
          ...
          instead placing more data into a single record, new events can be
          created as needed.
        </p>
        ...
        <p>
          ...
          endpoint. To simplify the initial implementation, systems do not have
          to retry if this request fails.
        </p>
      </div>
    </Layout>
  </React.Fragment>
