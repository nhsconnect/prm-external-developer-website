    ...
    <React.Fragment>
      <Header>
        <Header.Container>
          <Header.Logo />
          <Header.Title>
            Patient Record Migration: Developer website
          </Header.Title>
          <Header.Content>
            <Header.MenuToggle />
          </Header.Content>
        ...
        <div className="app-pane__main-content">
          ...
          <ul>
            <li>
              ...
              fields, it is hard to add new data to the existing specification.
            </li>
            <li>
            ...
            <li>
              ...
              that can be used to de-duplicate the MI records in the way
              outlined by the existing specification
            </li>
            <li>
            ...
            <li>
              Scope of data capture - When considering patient record migration
              as a whole, registration data is important for measuring the
              overall quality of the patient experience. Failures in GP2GP are
              often conflated with registration failures. It would be desirable
              to increase the scope of what we capture to include this
              information also.
            </li>
            <li>
              Delay in receiving updates - Currently we have to wait at least a
              month to get the MI data from all practices. This limits our
